...
//! palette rather than listing it: turning an id back into a shade, handing
//! one to the rasterizer, and finding the entry nearest an arbitrary color.
...
/// flat array rather than re-running `Color::hex`'s whole match for
