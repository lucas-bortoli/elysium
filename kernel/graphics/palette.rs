...
pub const GENERATED_BEGIN: &str = "generated from kernel/graphics/palette.rs";
...
/// `kernel/graphics/colors.rs`.
#[allow(dead_code)]
pub fn render_rust() -> String {
    let mut out = String::new();
    out.push_str("// Generated from kernel/graphics/palette.rs. Do not edit.\n\n");
...
mod tests {
    ...
    fn assert_generated_region(relative_path: &str, rendered: String) {
        ...
        panic!(
            "{relative_path} is out of step with kernel/graphics/palette.rs.\n\
