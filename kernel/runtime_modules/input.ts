...
declare function __input_is_key_down(key: Key): boolean;
declare function __input_was_key_pressed(key: Key): boolean;
declare function __input_was_key_released(key: Key): boolean;
